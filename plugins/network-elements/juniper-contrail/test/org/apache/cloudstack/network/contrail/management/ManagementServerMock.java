...
public class ManagementServerMock {
    ...
    private void locatePhysicalNetwork() {
        ...
        try {
            ...
            if (nets == null || nets.isEmpty()) {
                _networkService.addTrafficTypeToPhysicalNetwork(_znet.getId(), TrafficType.Public.toString(), "l3vpn", null, null, null, null, null, null);
            }
        ...
        if (!found) {
            _networkService.addTrafficTypeToPhysicalNetwork(_znet.getId(), TrafficType.Guest.toString(), "l3vpn",
